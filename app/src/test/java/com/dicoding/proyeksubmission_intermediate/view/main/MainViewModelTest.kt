...
import com.dicoding.proyeksubmission_intermediate.DataDummy
import com.dicoding.proyeksubmission_intermediate.MainDispatcherRule
...
import com.dicoding.proyeksubmission_intermediate.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        `when`(userRepository.getListStories()).thenReturn(expectedStory)
